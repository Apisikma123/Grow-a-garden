        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-[24px]">
            ...
            <div class="lg:col-span-3 bg-surface rounded-[24px] p-[24px] md:p-[40px] ambient-shadow-lg border border-outline-variant/20">
                ...
                <div class="relative bg-[#f1f5f2] rounded-[24px] p-6 mb-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border border-outline-variant/30 overflow-hidden">
                    ...
                    <div class="absolute -top-10 -right-10 w-48 h-48 bg-[#006c49]/10 rounded-full blur-3xl pointer-events-none"></div>
                    ...
                    <div class="flex flex-col sm:flex-row items-center sm:items-start md:items-center gap-5 relative z-10 w-full md:w-auto">
                        <div class="relative group cursor-pointer shrink-0">
                            ...
                            <div class="absolute -bottom-3 -right-3 bg-white rounded-full p-2 shadow-sm border border-outline-variant/20">
                                <span class="material-symbols-outlined text-[18px] text-[#006c49]">eco</span>
                            </div>
                        </div>
                        <div class="text-center sm:text-left mt-2 sm:mt-0">
                            ...
                            <div class="flex flex-wrap items-center justify-center sm:justify-start gap-2">
                                <span class="bg-[#006c49]/10 text-[#006c49] px-3 py-1.5 rounded-full text-[12px] font-bold tracking-wider uppercase border border-[#006c49]/20 shadow-sm backdrop-blur-md">Fase Vegetatif</span>
                ...
                <div class="relative pl-8 md:pl-12 space-y-[40px]">
                    ...
                    <div class="relative group cursor-pointer transition-transform duration-300 hover:translate-x-1">
                        <div class="absolute -left-[45px] md:-left-[53px] top-0 w-8 h-8 rounded-full bg-[#006c49] flex items-center justify-center shadow-[0_4px_12px_rgba(0,108,73,0.3)] z-10 group-hover:scale-110 transition-transform duration-300">
                            <span class="material-symbols-outlined text-[16px] text-white font-bold">check</span>
                        </div>
                        <div class="ml-4 md:ml-6">
                            <h3 class="text-[16px] font-bold text-[#006c49] mb-0.5">Tanam <span class="text-[12px] opacity-70 font-semibold">(Selesai)</span></h3>
                    ...
                    <div class="relative group cursor-pointer transition-transform duration-300 hover:translate-x-1">
                        ...
                        <div class="ml-4 md:ml-6">
                            <h3 class="text-[16px] font-bold text-[#006c49] mb-0.5">Germinasi <span class="text-[12px] opacity-70 font-semibold">(Selesai)</span></h3>
                    ...
                    <div class="relative group cursor-pointer transition-transform duration-300 hover:translate-x-1">
                        ...
                        <div class="ml-4 md:ml-6">
                            <h3 class="text-[16px] font-bold text-[#006c49] mb-0.5">Persemaian <span class="text-[12px] opacity-70 font-semibold">(Selesai)</span></h3>
                    ...
                    <div class="relative group">
                        {{-- Pulsing Ring --}}
                        <div class="absolute -left-[53px] md:-left-[61px] top-3 w-12 h-12 rounded-full bg-[#006c49]/20 animate-ping"></div>
                        <div class="absolute -left-[49px] md:-left-[57px] top-4 w-10 h-10 rounded-full bg-[#006c49] flex items-center justify-center shadow-[0_8px_24px_rgba(0,108,73,0.4)] ring-4 ring-white z-10">
                            <span class="material-symbols-outlined text-[20px] text-white">eco</span>
                        </div>
                        <div class="ml-4 md:ml-6 bg-gradient-to-br from-white to-[#006c49]/5 border border-[#006c49]/20 rounded-[20px] p-[24px] shadow-[0_8px_32px_rgba(0,108,73,0.08)] relative overflow-hidden transition-all duration-300 hover:shadow-[0_12px_48px_rgba(0,108,73,0.12)] hover:-translate-y-1">
                            <div class="absolute top-0 left-0 w-1.5 h-full bg-[#006c49]"></div>
                            <h3 class="text-[18px] font-black text-[#006c49] mb-1">Vegetatif <span class="text-[13px] bg-[#006c49] text-white px-2 py-0.5 rounded-full ml-2 font-bold tracking-wide">AKTIF</span></h3>
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <span class="text-[12px] text-[#006c49] font-black whitespace-nowrap bg-[#006c49]/10 px-3 py-1 rounded-full">12 hari lagi</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative opacity-70 hover:opacity-100 transition-all duration-300 cursor-pointer group hover:translate-x-1">
                        <div class="absolute -left-[45px] md:-left-[53px] top-0 w-8 h-8 rounded-full bg-surface border-2 border-dashed border-outline-variant flex items-center justify-center z-10 group-hover:border-[#006c49] group-hover:border-solid group-hover:bg-[#006c49]/10 group-hover:shadow-[0_0_16px_rgba(0,108,73,0.2)] transition-all duration-300">
                            <span class="material-symbols-outlined text-[16px] text-outline-variant group-hover:text-[#006c49] transition-colors">local_florist</span>
                        </div>
                        <div class="ml-4 md:ml-6">
                            <h3 class="text-[16px] font-bold text-on-surface-variant mb-0.5 group-hover:text-[#006c49] transition-colors">Berbunga</h3>
                    ...
                    <div class="relative opacity-60 hover:opacity-100 transition-all duration-300 cursor-pointer group hover:translate-x-1">
                        <div class="absolute -left-[45px] md:-left-[53px] top-0 w-8 h-8 rounded-full bg-surface border-2 border-dashed border-outline-variant flex items-center justify-center z-10 group-hover:border-[#006c49] group-hover:border-solid group-hover:bg-[#006c49]/10 group-hover:shadow-[0_0_16px_rgba(0,108,73,0.2)] transition-all duration-300">
                            <span class="material-symbols-outlined text-[16px] text-outline-variant group-hover:text-[#006c49] transition-colors">nutrition</span>
                        </div>
                        <div class="ml-4 md:ml-6">
                            <h3 class="text-[16px] font-bold text-on-surface-variant mb-0.5 group-hover:text-[#006c49] transition-colors">Berbuah</h3>
                    ...
                    <div class="relative opacity-50 hover:opacity-100 transition-all duration-300 cursor-pointer group hover:translate-x-1">
                        <div class="absolute -left-[45px] md:-left-[53px] top-0 w-8 h-8 rounded-full bg-surface border-2 border-dashed border-outline-variant flex items-center justify-center z-10 group-hover:border-[#006c49] group-hover:border-solid group-hover:bg-[#006c49]/10 group-hover:shadow-[0_0_16px_rgba(0,108,73,0.2)] transition-all duration-300">
                            <span class="material-symbols-outlined text-[16px] text-outline-variant group-hover:text-[#006c49] transition-colors">shopping_basket</span>
                        </div>
                        <div class="ml-4 md:ml-6">
                            <h3 class="text-[16px] font-bold text-on-surface-variant mb-0.5 group-hover:text-[#006c49] transition-colors">Panen</h3>
            ...
            <div class="lg:col-span-2 flex flex-col gap-[24px]">
                ...
                <div class="bg-white rounded-[24px] p-[28px] shadow-[0_4px_24px_rgba(0,0,0,0.03)] border border-outline-variant/30">
                    <h3 class="text-[18px] font-black text-slate-800 mb-5 flex items-center justify-between">
                        Tanaman Lainnya
                        <button class="text-[13px] text-[#006c49] font-bold hover:underline">Lihat Semua</button>
                    </h3>
                    <div class="space-y-3">
                        <div class="flex items-center justify-between p-3 rounded-[20px] border border-outline-variant/30 hover:border-[#006c49]/30 hover:shadow-[0_8px_24px_rgba(0,108,73,0.08)] cursor-pointer transition-all duration-300 group bg-white">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 class="text-[15px] font-bold text-slate-800 group-hover:text-[#006c49] transition-colors mb-1">Selada Romaine</h4>
                                    <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#006c49]/10 text-[#006c49] text-[10px] font-bold uppercase tracking-wider">
                                        <span class="w-1.5 h-1.5 rounded-full bg-[#006c49]"></span> PERSEMAIAN
                                    </span>
                                </div>
                            </div>
                            <span class="material-symbols-outlined text-outline-variant group-hover:text-[#006c49] group-hover:translate-x-1 transition-all mr-2">chevron_right</span>
                        </div>
                ...
                <div class="bg-[#f1f5f2] border border-[#006c49]/20 rounded-[24px] p-[32px] shadow-sm relative overflow-hidden group hover:border-[#006c49]/40 hover:shadow-md transition-all duration-300">
                    <span class="material-symbols-outlined absolute -top-4 -right-4 text-[120px] text-[#006c49]/5 -rotate-12 group-hover:rotate-0 transition-transform duration-700 pointer-events-none" style="font-variation-settings: 'FILL' 1;">format_quote</span>
                    
                    <div class="flex items-center gap-2 mb-6 relative z-10">
                        <div class="w-8 h-8 rounded-full bg-[#006c49]/10 flex items-center justify-center">
                            <span class="material-symbols-outlined text-[16px] text-[#006c49]">lightbulb</span>
                        </div>
                        <h3 class="text-[13px] text-[#006c49] font-bold uppercase tracking-widest">Tips Hari Ini</h3>
                    </div>
